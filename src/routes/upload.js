...
const jobUploadHandler = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (req.files.coverLetter) {
        ...
        yield coverLetter.mv(
          path_1.default.join(coverLettersDir, coverLetterFileName)
        );
      }
      const updatedApplication = yield job_1.default.findByIdAndUpdate(
        applicationId,
...
const volunteerUploadHandler = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
